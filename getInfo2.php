    ...
    font-weight: bold; font-size: 40px;">
        ...
        <table class="guide" style="width:70%;margin:auto;border-radius:1em;overflow: hidden;">
           ...
           <tr >
                <td>
                    <br>
                    <p>You have a <span >moderate </span>  level of psychological distress, which means you’ve likely been experiencing a little symptoms of distress over the past four weeks.</p>
